...
export default function SortReports({ onChange }) {   
    ...
    <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <a className="dropdown-item text-end" href='#' onClick={() => { changeOrder('incDate')}} >מהחדש לישן</a>
      <a className="dropdown-item text-end" href='#' onClick={() => {changeOrder('decDate') }} >ישן לחדש</a>
    </div>
